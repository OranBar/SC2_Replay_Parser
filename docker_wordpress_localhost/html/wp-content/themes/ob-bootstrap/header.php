			...
			<nav class="navbar navbar-dark bg-dark navbar-expand-lg">
				<div class="container">
					...
					<?php if (has_nav_menu("main_nav")) : ?>
						<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php _e('Toggle Navigation', 'simple-bootstrap'); ?>">
